...
export const metadata: Metadata = {
  title: "Join Our Team",
  description: "Join the Vetted Trainers team in Frederick, Maryland. We're looking for passionate fitness professionals who want to make a difference.",
  openGraph: {
    title: "Join Our Team | Vetted Trainers",
    description: "Become a Vetted Trainer. Join our team of expert personal trainers in Frederick, MD.",
    url: "https://www.vettedtrainers.com/join-our-team/",
  },
};
    ...
    <>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: "url('/images/get-to-work.jpg')" }}
        />
